...
class InvoiceController extends AdminBaseController
{
    ...
    public function index(InvoicesDataTable $dataTable)
    {
        ...
        if (!isset($this->setting->admins) || !isset($this->setting->maintainers) || !isset($this->setting->observers)) {
            return redirect(route('admin.outreach-settings.index'))->withErrors('Please update the settings first!');
        }
        ...
        return $dataTable->render('outreachmanagement::admin.invoices', $this->data);
    }
