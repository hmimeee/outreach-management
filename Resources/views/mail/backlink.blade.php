<table cellspacing="0" cellpadding="0" style="background-color: white; table-layout: fixed; font-size: 10pt; font-family: Arial; width: 0px; margin-left: 30%;">
    ...
    <tbody>
        ...
        <tr style="height: 21px;">
            ...
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: bottom; background-color: #00AEFF; font-family: Calibri; font-size: 11pt; font-weight: bold; color: rgb(255, 255, 255);"><span style="font-size: 11pt; font-family: Calibri, Arial;">ID: </span><span style="font-size: 12pt; font-family: Calibri, Arial;">#{{$backlink->id}}</span></td>
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: bottom; background-color: #00AEFF;">&nbsp;</td>
        ...
        <tr style="height: 29px;">
            ...
            <td rowspan="1" colspan="2" style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: #000;">{{ucfirst($backlink->type)}}</td>
            <td style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: rgb(0, 177, 231);">Cost:</td>
            <td rowspan="1" colspan="2" style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: #000;">${{$backlink->cost}}</td>
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: middle;">&nbsp;</td>
        </tr>
        <tr style="height: 29px;">
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: middle;">&nbsp;</td>
            <td style=" overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: rgb(0, 177, 231); border-right: 1px solid rgb(239, 239, 239); ">Status:</td>
            <td rowspan="1" colspan="2" style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: #000;">{{ucfirst($backlink->status)}}</td>
            <td style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: rgb(0, 177, 231);">Indexed:</td>
            <td rowspan="1" colspan="2" style="border-right: 1px solid rgb(239, 239, 239); border-bottom: 1px solid rgb(239, 239, 239); overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: #000;">{{$backlink->indexed ? 'Yes' : 'No'}}</td>
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: middle;">&nbsp;</td>
        </tr>
        ...
        <tr style="height: 35px;">
            <td style="overflow: hidden; padding: 2px 3px; vertical-align: top;">&nbsp;</td>
            <td style="border-right: 1px solid rgb(239, 239, 239);  overflow: hidden; padding: 2px 3px; vertical-align: middle; font-family: Calibri; font-size: 11pt; font-weight: bold; color: rgb(0, 177, 231);">Remarks:</td>
            ...
            <div style="max-height: 175px; font-family: Calibri;">
                ...
                {!! $backlink->comments->last()->message !!}
                @else
                {!! $backlink->remarks !!}
                @endif
            </div>
        ...
        <tr style="height: 50px;">
            <td colspan="8" align="center">
                <a href="{{$url}}?view-link={{$backlink->id}}" style="box-sizing: border-box; color: rgb(255, 255, 255); background-color: #00AEFF; border-image: initial; border-width: 10px 20px; border-style: solid; border-color: #00AEFF; border-radius: 50px; text-decoration-line: none;padding: 5px;font-weight: bold;">View Backlink</a>
            </td>
        </tr>
        @endif
